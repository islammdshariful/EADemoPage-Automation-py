...
class AdvancedTabs(Helper):
    ...
    tab_1 = f"//ul[@class='eael-tab-top-icon']//li[@id='philosophy']"
    ...
    tab_2_text = "MISSION"
    tab_2_1 = f"//div[@id='eael-advance-tabs-798ca354']//span[contains(@class,'title-after-icon')]" \
    ...
    tab_2_2 = f"//div[@id='eael-advance-tabs-798ca354']//span[contains(@class,'title-after-icon')]" \
    ...
    tab_2_3 = f"//div[@id='eael-advance-tabs-798ca354']//span[contains(@class,'title-after-icon')]" \
              f"[normalize-space()='Goals']"
    tab_2_3_text = "Goals"
    tab_2_3_des = f"//div[@id='eael-advance-tabs-798ca354']//div[@id='goals-tab']"
    tab_2_4 = f"//div[@id='eael-advance-tabs-798ca354']//span[contains(@class,'title-after-icon')]" \
    ...
    tab_3_text = "VISION"
    tab_3_1 = f"//ul[contains(@class,'eael-tab-top-icon')]//span[contains(@class,'title-after-icon')]" \
              f"[normalize-space()='Easy To Use']"
    tab_3_1_text = "Easy To Use"
    tab_3_1_des = f"//div[@id='eael-advance-tabs-3a353666']//div[@id='easy-to-use-tab']"
    tab_3_2 = f"//ul[contains(@class,'eael-tab-top-icon')]//span[contains(@class,'title-after-icon')]" \
              f"[normalize-space()='Mission & Vision']"
    tab_3_2_text = "Mission & Vision"
    tab_3_2_des = f"//div[@id='eael-advance-tabs-3a353666']//div[@id='mission-vision-tab']"
    tab_3_3 = f"//ul[contains(@class,'eael-tab-top-icon')]//span[contains(@class,'title-after-icon')]" \
              f"[normalize-space()='Goals']"
    tab_3_3_text = "Goals"
    tab_3_3_des = f"//div[@id='eael-advance-tabs-3a353666']//div[@id='goals-tab']"
    tab_3_4 = f"//ul[contains(@class,'eael-tab-top-icon')]//span[contains(@class,'title-after-icon')]" \
              f"[normalize-space()='Privacy Policy']"
    ...
    tab_4 = f"//ul[contains(@class,'eael-tab-top-icon')]//span[contains(@class,'title-after-icon')]" \
            f"[normalize-space()='GOALS']"
    tab_4_text = "GOALS"
