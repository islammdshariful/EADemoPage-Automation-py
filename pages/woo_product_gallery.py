...
class WooProductGallery(Helper):
    ...
    p_1_link_btn = f'//*[@id="eael-product-gallery"]/div/ul/li[1]/div/div[1]/div[2]/ul/li[3]'
    ...
    p_2_link_btn = f'//*[@id="eael-product-gallery"]/div/ul/li[2]/div/div[1]/div[2]/ul/li[3]'
    ...
    p_3_link_btn = f'//*[@id="eael-product-gallery"]/div/ul/li[3]/div/div[1]/div[2]/ul/li[3]'
    ...
    q_image = '//*[@id="product-"]/div[1]/div/figure/div/img'
    q_cart_btn = f'//*[@id="product-"]/div[2]/form/button'
    ...
    def check_product_info(self, img, title, title_text, price, price_text, cart_btn, qv_btn, link_btn):
        WebDriverWait(self.browser, 10).until(EC.element_to_be_clickable((By.XPATH, cart_btn)))
    ...
    def testcase(self):
        ...
        if self.check_doc:
            ...
            assert_that(self.browser.find_element(By.XPATH, f"//h1[@class='product_title entry-title']")
