...
class OffCanvas:
    ...
    right_side = (By.XPATH, f'//*[@id="post-3926"]/div/div/div/div/section[2]/div/div/div/div/div/div[3]'
                            f'/div/div/div/div/span[2]')
    left_img = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[1]/div/div/img')
    left_home = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[1]/a/span')
    left_about = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[2]')
    left_service = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[3]')
    left_blog = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[4]')
    left_faq = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[5]')
    left_contact = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[6]')
    left_button = (By.XPATH, f'/html/body/div[9]/div/div/div/section/div/div/div/div/div/div[3]/div/div/a/span/span')
    blank = (By.XPATH, f'/html/body/div[11]')

    right_img = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[1]/div/div/img')
    right_home = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[1]/a/span')
    right_about = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[2]')
    right_service = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[3]')
    right_blog = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[4]')
    right_faq = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[5]')
    right_contact = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[2]/div/ul/li[6]')
    right_button = (By.XPATH, f'/html/body/div[8]/div/div/div/section/div/div/div/div/div/div[3]/div/div/a/span/span')
